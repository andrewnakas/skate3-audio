...
| `bitstream.rs` | `sub_82B26B70`, `sub_82B4F5F8`, `sub_82B46EA0`, `sub_82B46FB0`, `sub_82B47010`, `sub_82B47658`, `sub_82B50270`: the packet stream's decoders — an MSB-first bit reader, an unsigned and a zigzag-signed variable-length code, the run-length layer over them, and a paged bit cursor | **20,000 replayed** (8,807 + 5,713 + 1,960 + 980 + 980 + 245 + 1,315) |
