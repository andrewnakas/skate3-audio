...
status: pending | written | armed | verified | promoted | divergent | uncalled | gate1 | gate2 | gate3 | gate4
"""
...
STATUSES = ("pending", "written", "armed", "verified", "promoted", "divergent", "uncalled",
